    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li class="font-medium text-primary">Liste</li>
            </ol>
        </nav>
    </div>
    <!-- Breadcrumb End -->
                                                            ...
                                                            <div class="-mx-3 flex flex-wrap gap-y-4">
                                                                ...
                                                                <div class="w-full px-3 2xsm:w-1/2">
                                                                    <form action="{{route('changeStatus.stocke_restauration', $value->id)}}" method="post">
                                                                        @csrf
                                                                        <button
                                                                            class="block w-full rounded border border-meta-{{ $value->status === 'ACTIF' ? '1' : '3' }} bg-meta-{{ $value->status === 'ACTIF' ? '1' : '3' }} p-3 text-center font-medium text-white transition hover:bg-opacity-90">
                                                                            {{ $value->status === 'ACTIF' ? 'Désactivé' : 'Activé' }}
                                                                        </button>
                                                                    </form>
                                                                </div>
    ...
    <div class="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
        <div class="flex flex-col rounded-sm  bg-white p-3  dark:border-strokedark dark:bg-boxdark sm:flex-row sm:items-center sm:justify-between">
            <div class="flex flex-col gap-4 2xsm:flex-row 2xsm:items-center">
                <a href="{{route('fetchStockesDesactives.stocke_restauration')}}" class="flex items-center gap-2 rounded bg-primary px-4.5 py-2 font-medium text-white hover:bg-opacity-80" id="btn-submited">
                    <svg class="fill-current" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex flex-col gap-4 2xsm:flex-row 2xsm:items-center">
                <a href="{{route('fetchStockesManquants.stocke_restauration')}}" class="flex items-center gap-2 rounded bg-danger px-4.5 py-2 font-medium text-white hover:bg-opacity-80" id="btn-submited">
                    <svg class="fill-current" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M15 7H9V1C9 0.4 8.6 0 8 0C7.4 0 7 0.4 7 1V7H1C0.4 7 0 7.4 0 8C0 8.6 0.4 9 1 9H7V15C7 15.6 7.4 16 8 16C8.6 16 9 15.6 9 15V9H15C15.6 9 16 8.6 16 8C16 7.4 15.6 7 15 7Z" fill=""></path>
                    </svg>
                    Stockes Manquants
