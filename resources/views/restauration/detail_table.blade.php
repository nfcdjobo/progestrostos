    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li class="font-medium text-primary">Détail Table</li>
            </ol>
        </nav>
    </div>
    <!-- Breadcrumb End -->
            ...
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                <div class="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
                    <div class="flex flex-col rounded-sm  bg-white p-3  dark:border-strokedark dark:bg-boxdark sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <a href="{{route('table')}}" type="button" class="flex items-center gap-2 rounded bg-[#212B36] px-4.5 py-2 font-medium text-white hover:bg-opacity-80">
                ...
                <div class="flex flex-col mt-6 gap-9">
                    ...
                    <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                        ...
                        <form action="{{route('update.table', $table->id)}}" method="POST">
                            @csrf
                            <div class="flex flex-col gap-6">
                                <!-- Accordion Item -->
                                <div x-data="{ accordionOpen: false }" @click.outside="accordionOpen = false" class="rounded-md border border-stroke p-4 shadow-9 dark:border-strokedark dark:shadow-none sm:p-6">
                                    <button type="button" @click="accordionOpen = !accordionOpen" class="flex w-full items-center gap-1.5 sm:gap-3 xl:gap-6">
                                        <div class="flex h-10.5 w-full max-w-10.5 items-center justify-center rounded-md bg-[#F3F5FC] dark:bg-meta-4">
                                            <svg :class="accordionOpen &amp; amp; &amp; amp; 'rotate-180'" class="fill-primary stroke-primary duration-200 ease-in-out dark:fill-white dark:stroke-white" width="18" height="10" viewBox="0 0 18 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div>
                                            <h4 class="text-left text-title-xsm font-medium text-black dark:text-white"> PLACE BAS NIVEAU ({{$table->vip->name}}) </h4>
                                        </div>
                                    </button>
                                    ...
                                    <div x-show="accordionOpen" class="ml-16.5 mt-5 duration-200 ease-in-out" style="display: none;">
                                        <div class="p-6.5">
                                            <div class="mb-4.5 flex flex-col gap-6 xl:flex-row form_group_input" id="form_group_input_1">
                                                ...
                                                <div class="w-full xl:w-1/2">
                                                    <label class="mb-3 block text-sm font-medium text-black dark:text-white" for="numero">Numéro de table </label>
                                                    <input type="text" id="numero" name="numero" value="{{$table->numero}}" required="" placeholder="Exemple: TBL-" class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary">
                                                </div>

                                                <div class="w-full xl:w-1/2">
                                                    <input type="number" min="1" id="activite_id" value="{{$table->activite_id}}" name="activite_id1" required class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" hidden>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="p-6.5">
                                <button type="submit" class="flex justify-center rounded bg-success p-3 font-medium text-gray hover:bg-opacity-90"> Sauvegarder </button>
                            </div>
                        </form>
                    ...
                    <div class="p-6.5">
                        <div class="mb-4.5 flex flex-col gap-6 xl:flex-row form_group_input" id="form_group_input_1">
                            <div class="w-full xl:w-1/2">
                                ...
                                <input type="text" id="libelle_1" @if ($table) value="{{$table->name}}" @endif name="libelle_1" required placeholder="Libelle produit" class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                            </div>
                            ...
                            <div class="w-full xl:w-1/2">
                                ...
                                <input type="number" min="1" id="prix_unitaire_1" name="prix_unitaire_1" required placeholder="Enter your last name" class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                            </div>
