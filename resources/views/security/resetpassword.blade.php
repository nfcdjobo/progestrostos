    ...
    <div
            ...
            >
              ...
              <nav>
                <ol class="flex items-center gap-2">
                  <li>
                    <a class="font-medium" href="index.html">Tableau de Bord /</a>
                  </li>
            ...
            >
              <div class="flex flex-wrap items-center">
                <div
                  class="hidden w-full border-stroke dark:border-strokedark xl:block xl:w-1/2 xl:border-r-2">
                  <div class="px-26 py-17.5 text-center">
                    <a class="mb-5.5 inline-block" href="index.html">
                      <img
                        class="hidden dark:block" @if ($my_banniere) src="{{$my_banniere->logo}}"  @endif
                ...
                <div class="w-full xl:w-1/2">
                  <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                    <h2
                      class="mb-3 text-2xl font-bold text-black dark:text-white sm:text-title-xl2"
                    >
                      Reset Password
                    </h2>
