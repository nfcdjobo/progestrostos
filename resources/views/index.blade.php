...
@section('content')
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li class="font-medium text-primary">Tableau de Bord</li>
            </ol>
        </nav>
    </div>

    <!-- ====== Chart Four Start -->
    <div class="col-span-12 mb-6 flex flex-wrap items-center justify-between gap-3">
        <!-- Datepicker built with flatpickr -->
        <div class="relative">
            <input class="datepicker w-[120%] rounded border border-stroke bg-white py-2 pl-10 pr-4 text-sm font-medium shadow-card-2 focus-visible:outline-none dark:border-strokedark dark:bg-boxdark"
        ...
        <div class="relative z-20 inline-block rounded bg-white shadow-card-2 dark:bg-boxdark">
            <div class="col-span-1 relative">
                <div x-data="{ isOpen: false }">
                    ...
                    <div @click.outside="isOpen = false" x-show="isOpen" class="absolute w-full right-0 top-full z-1 mt-1 w-full rounded-[5px] bg-white py-2.5 shadow-12 dark:bg-boxdark" style="display: none;">

                        <a href="{{route('dashboard', 'annuel')}}" onclick="(event)=>{document.getElementById('textosin').textContent = event.target.textContent}" class="flex w-full px-4 py-2 text-sm hover:bg-whiter hover:text-primary dark:hover:bg-meta-4">
                            Annuel
                        </a>
                        <a href="{{route('dashboard', 'mensuel')}}" onclick="(event)=>{document.getElementById('textosin').textContent = event.target.textContent}" class="flex w-full px-4 py-2 text-sm hover:bg-whiter hover:text-primary dark:hover:bg-meta-4">
                            Mensuel
                        </a>
                        <a href="{{route('dashboard', 'herbdomataire')}}" onclick="(event)=>{document.getElementById('textosin').textContent = event.target.textContent}" class="flex w-full px-4 py-2 text-sm hover:bg-whiter hover:text-primary dark:hover:bg-meta-4">
                            Herbdomataire
                        </a>

                        <a href="{{route('dashboard', 'quotidient')}}" onclick="(event)=>{document.getElementById('textosin').textContent = event.target.textContent}" class="flex w-full px-4 py-2 text-sm hover:bg-whiter hover:text-primary dark:hover:bg-meta-4">
                            Quotidient
                        </a>
                    </div>
                </div>
    ...
    <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div x-data="{ accordionOpen: false }" @click.outside="accordionOpen = false" class="rounded-md border border-stroke p-4 shadow-9 dark:border-strokedark dark:shadow-none md:p-6 xl:p-7.5">
            ...
            <button @click="accordionOpen = !accordionOpen" class="flex w-full items-center justify-between gap-2">
                ...
                <div class="flex h-9 w-full max-w-9 items-center justify-center rounded-full border border-primary dark:border-white">
                    ...
                    <svg :class="accordionOpen === true ? 'block' : 'hidden'" class="fill-primary dark:fill-white" width="15" height="3" viewBox="0 0 15 3" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
                            ...
                            <div class="mt-4 flex items-end justify-between">
                                <div>
                                    ...
                                    <span class="text-sm font-medium">Recette Cumulée</span>
                                </div>
                        ...
                        <div class="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
                            ...
                            <div class="mt-4 flex items-end justify-between">
                                <div>
                                    ...
                                    <span class="text-sm font-medium">Profile Cumiulé</span>
                                </div>
                        ...
                        <div class="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
                            ...
                            <div class="mt-4 flex items-end justify-between">
                                <div>
                                    ...
                                    <span class="text-sm font-medium">Dépenses Cumilés</span>
                                </div>
                        ...
                        <div class="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
                            ...
                            <div class="mt-4 flex items-end justify-between">
                                <div>
                                    ...
                                    <span class="text-sm font-medium">Plats Vendus</span>
                                </div>
                        ...
                        <div class="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
                            ...
                            <div class="mt-4 flex items-end justify-between">
                                <div>
                                    ...
                                    <span class="text-sm font-medium">Nombre de Tables</span>
                                </div>
                        ...
                        <div class="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
                            ...
                            <div class="mt-4 flex items-end justify-between">
                                <div>
                                    ...
                                    <span class="text-sm font-medium">Tables Occupées</span>
                                </div>
                        ...
                        <div class="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
                            ...
                            <div class="mt-4 flex items-end justify-between">
                                <div>
                                    ...
                                    <span class="text-sm font-medium">Tables Libres</span>
                                </div>
                        ...
                        <div class="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
                            ...
                            <div class="mt-4 flex items-end justify-between">
                                <div>
                                    ...
                                    <span class="text-sm font-medium">Clients du Jour</span>
                                </div>
            ...
            <div x-show="accordionOpen" class="mt-5 duration-200 ease-in-out">
                <div class="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
                    ...
                    <div class="col-span-12 rounded-sm border border-stroke bg-white py-6 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-4">
                        <h4 class="mb-6 px-7.5 text-xl font-bold text-black dark:text-white">  </h4>
                        ...
                        <div>
                            <a href="messages.html" class="flex items-center gap-5 px-7.5 py-3 hover:bg-gray-3 dark:hover:bg-meta-4">
                                <div class="relative h-14 w-14 rounded-full">
                                    ...
                                    <sp class="absolute bottom-0 right-0 h-3.5 w-3.5 rounded-full border-2 border-white bg-meta-3"></spaclass=>
                                </div>
                            ...
                            <a href="messages.html" class="flex items-center gap-5 px-7.5 py-3 hover:bg-gray-3 dark:hover:bg-meta-4">
                                <div class="relative h-14 w-14 rounded-full">
                                    ...
                                    <sp class="absolute bottom-0 right-0 h-3.5 w-3.5 rounded-full border-2 border-white bg-meta-3"></span>
                                </div>
                            ...
                            <a href="messages.html" class="flex items-center gap-5 px-7.5 py-3 hover:bg-gray-3 dark:hover:bg-meta-4">
                                <div class="relative h-14 w-14 rounded-full">
                                    ...
                                    <sp class="absolute bottom-0 right-0 h-3.5 w-3.5 rounded-full border-2 border-white bg-meta-6"></span>
                                </div>
                            ...
                            <a href="messages.html" class="flex items-center gap-5 px-7.5 py-3 hover:bg-gray-3 dark:hover:bg-meta-4">
                                <div class="relative h-14 w-14 rounded-full">
                                    ...
                                    <sp class="absolute bottom-0 right-0 h-3.5 w-3.5 rounded-full border-2 border-white bg-meta-7"></span>
                                </div>
