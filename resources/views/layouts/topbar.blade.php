...
<header class="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
    <div class="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
            ...
            <!-- Hamburger Toggle BTN -->
            <a class="block w-11 flex-shrink-0 lg:hidden" href="index.html">
                <img @if ($my_banniere) src="{{ $my_banniere->logo }}"  @endif alt="Logo" />
            </a>
        </div>
        <div class="hidden sm:block">
            <form action="#" method="POST">
                <div class="relative">
                    ...
                    <input type="text" placeholder="Saisir pour chercher..." class="w-full bg-transparent pl-9 pr-4 focus:outline-none xl:w-125" />
                </div>
            </form>
        </div>
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center gap-4" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
                    <span class="hidden text-right lg:block">
                        ...
                        <span class="block text-sm font-medium text-black dark:text-white" id="fullnameUser">{{$userAuth->fullname}}</span>
                        <span class="block text-xs font-medium">{{$userAuth->role->name}}</span>
                    </span>
                    <span class="inline-block border border-black p-1 rounded-full">
                        <canvas id="roundedCanvas" width="30" height="30"></canvas>
                    </span>
